...
namespace akarnokd.reactive_extensions
{
    ...
    internal sealed class Cache<T> : IObservable<T>, IObserver<T>, IDisposable
    {
        ...
        public Cache(IObservable<T> source, Action<IDisposable> cancel, int capacityHint)
        {
            this.source = source;
            this.cancel = cancel;
        ...
        internal sealed class CacheConsumerDisposable : IDisposable
        {
            ...
            public CacheConsumerDisposable(IObserver<T> downstream, Cache<T> parent, Node head)
            {
