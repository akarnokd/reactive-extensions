...
namespace akarnokd.reactive_extensions
{
    ...
    internal sealed class ObservableSourceCreate<T> : IObservableSource<T>
    {
        readonly Action<ISignalEmitter<T>> onSubscribe;

        readonly bool serialize;

        public ObservableSourceCreate(Action<ISignalEmitter<T>> onSubscribe, bool serialize)
        {
        ...
        internal sealed class CreateDisposableEmitter : ISignalEmitter<T>, IDisposable
        {
            readonly ISignalObserver<T> downstream;

            IDisposable resource;

            public CreateDisposableEmitter(ISignalObserver<T> downstream)
            {
        ...
        internal sealed class CreateDisposableSerializedEmitter : ISignalEmitter<T>, IDisposable
        {
            readonly ISignalObserver<T> downstream;
            ...
            public CreateDisposableSerializedEmitter(ISignalObserver<T> downstream)
            {
                this.downstream = downstream;
            }
