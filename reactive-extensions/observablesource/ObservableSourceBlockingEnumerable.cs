...
namespace akarnokd.reactive_extensions
{
    ...
    internal sealed class ObservableSourceBlockingEnumerable<T> : IEnumerable<T>
    {
        readonly IObservableSource<T> source;

        public ObservableSourceBlockingEnumerable(IObservableSource<T> source)
        {
            this.source = source;
        }
        ...
        sealed class BlockingEnumerator : IEnumerator<T>, ISignalObserver<T>
        {
