...
{
    internal sealed class ObservableSourceTakeUntil<T, U> : IObservableSource<T>
    {
        readonly IObservableSource<T> source;

        readonly IObservableSource<U> other;

        public ObservableSourceTakeUntil(IObservableSource<T> source, IObservableSource<U> other)
        {
            this.source = source;
            this.other = other;
        }
