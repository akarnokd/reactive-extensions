...
{
    internal abstract class SingleMergeCoordinator<T> : IDisposable
    {
        ...
        protected SingleMergeCoordinator(IObserver<T> downstream, bool delayErrors)
        {
        ...
        {
            readonly SingleMergeCoordinator<T> parent;

            IDisposable upstream;

            public InnerObserver(SingleMergeCoordinator<T> parent)
            {
                this.parent = parent;
            }
