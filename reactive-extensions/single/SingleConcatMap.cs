...
namespace akarnokd.reactive_extensions
{
    ...
    internal sealed class SingleConcatMap<T, R> : IObservable<R>
    {
        ...
        public SingleConcatMap(IObservable<T> source, Func<T, ISingleSource<R>> mapper, bool delayErrors)
        {
            this.source = source;
            this.mapper = mapper;
        ...
        sealed class ConcatMapObserver : IObserver<T>, IDisposable
        {
            ...
            public ConcatMapObserver(IObserver<R> downstream, Func<T, ISingleSource<R>> mapper, bool delayErrors)
            {
            ...
            sealed class InnerObserver : ISingleObserver<R>, IDisposable
            {
