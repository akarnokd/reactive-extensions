...
namespace akarnokd.reactive_extensions
{
    ...
    internal sealed class SingleMerge<T> : IObservable<T>
    {
        ...
        public SingleMerge(ISingleSource<T>[] sources, bool delayErrors, int maxConcurrency)
        {
        ...
        sealed class MergeLimitedCoordinator : SingleMergeCoordinator<T>
        {
            ...
            internal MergeLimitedCoordinator(IObserver<T> downstream, ISingleSource<T>[] sources, bool delayErrors, int maxConcurrency) : base(downstream, delayErrors)
            {
                this.sources = sources;
                this.maxConcurrency = maxConcurrency;
            }
