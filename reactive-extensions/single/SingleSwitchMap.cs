...
namespace akarnokd.reactive_extensions
{
    ...
    internal sealed class SingleSwitchMap<T, R> : IObservable<R>
    {
        ...
        public SingleSwitchMap(IObservable<T> source, Func<T, ISingleSource<R>> mapper, bool delayErrors)
        {
            this.source = source;
            this.mapper = mapper;
        ...
        sealed class SwitchMapObserver : IObserver<T>, IDisposable
        {
            ...
            public SwitchMapObserver(IObserver<R> downstream, Func<T, ISingleSource<R>> mapper, bool delayErrors)
            {
            ...
            public void OnNext(T value)
            {
                ...
                try
                {
                    src = RequireNonNullRef(mapper(value), "The mapper returned a null ISingleSource");
                }
                catch (Exception ex)
                {
                    OnError(ex);
            ...
            internal sealed class InnerObserver : ISingleObserver<R>, IDisposable
            {
