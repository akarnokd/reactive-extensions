...
namespace akarnokd.reactive_extensions
{
    ...
    /// </summary>
    /// <remarks>Since 0.0.12</remarks>
    internal sealed class ConcatEagerAllCoordinator<T> : MaybeConcatEagerCoordinator<T>
    {
        bool done;

        internal ConcatEagerAllCoordinator(IObserver<T> downstream, bool delayErrors) : base(downstream, delayErrors)
        {
        }
