...
namespace akarnokd.reactive_extensions
{
    ...
    internal sealed class MaybeConcatMapEager<T, R> : IObservable<R>
    {
        ...
        public MaybeConcatMapEager(IObservable<T> source, Func<T, IMaybeSource<R>> mapper, bool delayErrors, int maxConcurrency)
        {
            this.source = source;
            this.mapper = mapper;
        ...
        sealed class ConcatEagerLimitedCoordinator : MaybeConcatEagerCoordinator<R>, IObserver<T>
        {
            readonly Func<T, IMaybeSource<R>> mapper;
            ...
            internal ConcatEagerLimitedCoordinator(IObserver<R> downstream, Func<T, IMaybeSource<R>> mapper, int maxConcurrency, bool delayErrors) : base(downstream, delayErrors)
            {
                this.mapper = mapper;
                this.maxConcurrency = maxConcurrency;
