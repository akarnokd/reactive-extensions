...
namespace akarnokd.reactive_extensions
{
    ...
    internal sealed class MaybeWait<T> : CountdownEvent, IMaybeObserver<T>
    {
        IDisposable upstream;

        Exception error;

        public MaybeWait() : base(1)
        {
        }
    ...
    /// <typeparam name="T">The success value type.</typeparam>
    /// <remarks>Since 0.0.11</remarks>
    internal sealed class MaybeWaitValue<T> : CountdownEvent, IMaybeObserver<T>
    {
        IDisposable upstream;
