...
namespace akarnokd.reactive_extensions
{
    ...
    internal sealed class MaybeCache<T> : IMaybeSource<T>, IMaybeObserver<T>, IDisposable
    {
        ...
        public MaybeCache(IMaybeSource<T> source, Action<IDisposable> cancel)
        {
            this.source = source;
            this.cancel = cancel;
        ...
        {
            internal readonly IMaybeObserver<T> dowstream;

            MaybeCache<T> parent;

            public CacheDisposable(IMaybeObserver<T> dowstrean, MaybeCache<T> parent)
            {
