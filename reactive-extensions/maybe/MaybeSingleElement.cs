...
namespace akarnokd.reactive_extensions
{
    ...
    internal sealed class MaybeSingleElement<T> : IMaybeSource<T>
    {
        readonly IObservable<T> source;

        public MaybeSingleElement(IObservable<T> source)
        {
            this.source = source;
        }
        ...
        sealed class SingleElementObserver : IObserver<T>, IDisposable
        {
            ...
            public SingleElementObserver(IMaybeObserver<T> downstream)
            {
